        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title mb-0">Region List</h5>
                    <div>
                        ...
                        <a title="Export Excel" href="{{ route('regions.export') }}" class="btn btn-success btn-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table align-middle table-nowrap mb-0" id="region-table">
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="FilterCanvas" aria-labelledby="FilterCanvasLabel">
        ...
        <form id="filter-form" class="d-flex flex-column justify-content-end h-100">
            ...
            <div class="offcanvas-footer border-top p-3 text-center">
                <div class="row">
                    <div class="col-6">
                        <button title="Apply Filters" type="button" class="btn btn-primary btn-sm w-100" id="apply-btn">Apply Filters</button>
                    </div>
                    <div class="col-6">
                        <button title="Reset" type="button" class="btn btn-light btn-sm w-100" id="reset-btn">Reset</button>
                    </div>
                </div>
            </div>
        </form>
...
<script>
    ...
    $(document).ready(function() {
        ...
        const table = $('#region-table').DataTable({
            ...
            destroy: true,
            ajax: {
                url: "{{ route('regions.getRegionList') }}",
                type: 'POST',
                headers: {
