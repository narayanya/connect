...
@section('content')
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control  required" 
               ...
               value="{{ old('payment_terms', $data->payment_terms ?? '') }}">
    ...
    <div class="form-group">
        ...
        <select class="form-select js-select2 " 
            ...
            <option value="">Select Gender</option>@foreach($gender_list as $list)<option value="{{$list->id}}"{{ old("gender", $data->gender ?? "") == $list->id ? "selected" : "" }}>{{ $list->gender }}</option>@endforeach
        </select>
