...
@push('page-back-button')
    <a href="{{ route('gender.index') }}" class="btn btn-outline-secondary me-2">
    ...
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="POST" action="@isset($data->id){{ route('gender.update', $data->id) }}@else{{ route('gender.store') }}@endisset" enctype="multipart/form-data" class="needs-validation" novalidate>
                    @isset($data->id)
                        @method('PUT')
                    @endisset
                    @csrf
